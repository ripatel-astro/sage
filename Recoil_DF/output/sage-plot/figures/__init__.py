...
from . import (
    ...
    black_hole_galtype_relation,
    black_hole_bulge_relation,
    black_hole_recoil_relation,
    black_hole_mass_relation, 
    black_hole_nsc_relation,
    black_hole_occupation_fraction,
    black_hole_recoil_distribution_events,
    bulge_mass_fraction,
    gas_fraction,
    gas_mass_function,
    halo_occupation,
    ...
    velocity_dispersion_distribution,
    virial_radius_distribution,
)
...
PLOT_FUNCS = {
    ...
    "black_hole_galtype_relation": black_hole_galtype_relation.plot,
    "black_hole_bulge_relation": black_hole_bulge_relation.plot,
    "black_hole_recoil_relation":  black_hole_recoil_relation.plot,
    "black_hole_mass_relation": black_hole_mass_relation.plot,
    "black_hole_nsc_relation": black_hole_nsc_relation.plot,
    "black_hole_occupation_fraction": black_hole_occupation_fraction.plot,
    "black_hole_recoil_distribution_events": black_hole_recoil_distribution_events.plot,
    "gas_fraction": gas_fraction.plot,
    "metallicity": metallicity.plot,
    "nsc_mass_relation":nsc_mass_relation.plot,
    "nsc_occupation_fraction":nsc_occupation_fraction.plot,
    "ics_mass_relation": ics_mass_relation.plot, 
    ...
    "velocity_dispersion_distribution": velocity_dispersion_distribution.plot,
    "mass_reservoir_scatter": mass_reservoir_scatter.plot,
    "spatial_distribution": spatial_distribution.plot,
    "velocity_dispersion_distribution": virial_radius_distribution.plot,
}
