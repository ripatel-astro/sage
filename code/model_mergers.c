...
void add_galaxies_together(int t, int p) {
  ...
  if(Gal[t].PrimaryBHMass > 0 && Gal[t].SecondaryBHMass > 0) { 
    if(Gal[t].PrimaryBHMass >= Gal[t].SecondaryBHMass) {
      Gal[t].BHMassRatio = Gal[t].SecondaryBHMass/Gal[t].PrimaryBHMass;
    }
    else {
      Gal[t].BHMassRatio = Gal[t].PrimaryBHMass/Gal[t].SecondaryBHMass;
    }
  }
  else {
    Gal[t].BHMassRatio = 0;
  ...
  if (SageConfig.BHRecoilOn == 1) {
    ...
    int e=0 , a_1=0, a_2=0, xi=0, phi_1=0, phi_2=0, theta=0;
  ...
  if(Gal[t].BHRecoilVmag >= Vesc){
    ...
    Gal[t].BlackHoleMass = 0; //this removes the ejected black hole from the galaxy
    Gal[t].PrimaryBHMass = 0;
    Gal[t].SecondaryBHMass = 0;
    //printf("PrimaryBH: %.2e SecondaryBH: %.2e EjectedMass: %.2e BlackHoleMass:%.2e RecoilMag: %.2e Vesc: %.2e\n ", Gal[t].PrimaryBHMass, Gal[t].SecondaryBHMass, Gal[t].BHEjectedMass, Gal[t].PrimaryBHMass+Gal[t].SecondaryBHMass, Gal[t].BHRecoilVmag, Vesc);
  }
  else {
    Gal[t].BHEjectedMass = 0;
  } 
