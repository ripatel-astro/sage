...
double calc_recoil_velocity(float q, int e, int a_1, int a_2, int xi, int phi_1, int phi_2, int theta){
  ...
  v_par = (K*p*cos(theta))*(a_2_perp - q*a_1_perp); //velocity parallel to orbital angular momentum direction
