...
static ParameterDefinition ParameterTable[] = {
    ...
    {"BHRecoilOn", "BH recoil switch (0=off, 1/2/3/4=different spin configurations)", INT,
     &SageConfig.BHRecoilOn, 1, 0.0, 4.0},
    {"NuclearStarClustersOn", "NSC switch (0=off, 1=on)", INT,
     &SageConfig.NuclearStarClustersOn, 1, 0.0, 1.0},
    ...
    {"NSCMassScatter", "Nuclear star cluster mass scatter", DOUBLE,
     &SageConfig.NSCMassScatter, 1, 0.0, 0.0},
