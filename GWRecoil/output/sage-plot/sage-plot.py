...
def get_galaxy_dtype():
    ...
    galdesc_full = [
        ...
        ("PrimaryBHSpin", np.float32),
        ("SecondaryBHSpin", np.float32),
        ("BHMassRatio", np.float32),
        ("BHRecoilVmag", np.float32),
        ("BHEjectedMass", np.float32),
        ("MassofLastEjectedBH", np.float32),
        ("TimeofLastEjectedBH", np.float32),
        ("TimeofLastRefilledBH", np.float32),
        ("BHmergeType", np.int32),
        ("BHmergeCount", np.int32),
        ("BHejectFlag", np.int32),
