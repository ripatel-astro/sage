...
- `nsc_mass`: Galaxy stellar mass vs nuclear star cluster mass
- `nsc_occupation_fraction`: Galaxy stellar mass vs NSC occupation fraction
- `black_hole_bulge_relation`: Black hole mass vs. bulge mass relation
- `black_hole_recoil_relation`: Black hole mass ratio vs GW recoil velocity
...
- `virial_radius_distribution`: Distribution of virial radii
...
- `velocity_dispersion`: Distribution of galaxy velocity dispersions
